...
// import 'const.dart';
// import 'ui_lyrics_shazam.dart';

// // void main() {
// //   runApp(MaterialApp(home: TestPluging()));
// // }

// class TestPluging extends StatefulWidget {
//   @override
//   _TestPlugingState createState() => _TestPlugingState();
// }

// class _TestPlugingState extends State<TestPluging>
//     with SingleTickerProviderStateMixin {
//   AudioPlayer? audioPlayer;
//   double sliderProgress = 0;
//   int playProgress = 0;
//   double max_value = 3000;
//   bool isTap = false;
...
//   var lyricUI = CustomUIShazam();

//   @override
//   void initState() {
//     super.initState();

//     print(ParserSmart(mylyric).isOK());
//   }
...
//               onPressed: () async {
//                 if (audioPlayer == null) {
//                   audioPlayer = AudioPlayer()..play(AssetSource("audio.mp3"));
//                   setState(() {
//                     playing = true;
//                   });
...
//   void refreshLyric() {
//     lyricUI = CustomUIShazam.clone(lyricUI);
//   }
