...
class AdminAddChapitre extends StatefulWidget {
  Map<String, dynamic> map_data = {};

  AdminAddChapitre(Map<String, dynamic> k) {
    map_data = k;
  }

  @override
  State<AdminAddChapitre> createState() =>
      _AdminAddChapitreState(this.map_data);
}

class _AdminAddChapitreState extends State<AdminAddChapitre> {
  bool isload = false;
  Map<String, dynamic> map_data;
  ...
  void btn_send() async {
    ...
    showloading(context);
    if (map_data.containsKey('quiz')) {
      map_data.remove('quiz');
      print('deleted');
    }
    Map<String, dynamic> conn = await insert_data(map_data, "Chapitres");
    print("ici  ");
    if (conn["status"] != "OK") {
      exitloading(context);
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Chapitre Ajouté ✅")));
    }
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
                      ...
                      builder: (context) => AlertDialog(
                          ...
                          content: Container(
                            ...
                            child: IntrinsicHeight(
                              child: Column(
                                children: [
                                  get_col_textfield("num_chapitre",
                                      readonly: true),
            ...
            title: Column(
              ...
              children: [
                Text(
                  "Chapitre : " + map_data["num_chapitre"].toString(),
                  style: TextStyle(
                      fontSize: 14,
  ...
  Widget get_col_textfield(String titre,
      {bool readonly = false, int mini = 1, int maxi = 1}) {
    return Container(
