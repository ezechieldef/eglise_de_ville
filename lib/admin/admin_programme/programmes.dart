...
class AdminProgramme extends StatefulWidget {
  ZoomDrawerController zoomDrawerController;
  AdminProgramme(this.zoomDrawerController);

  @override
  State<AdminProgramme> createState() => _AdminProgrammeState();
}

class _AdminProgrammeState extends State<AdminProgramme> {
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: Text(
                                                          formatTimeOfDay(TimeOfDay.fromDateTime(DateTime.parse("1990-01-01 " + list_progr[i]["Heure_Debut"].toString()))) +
                                                              " - " +
